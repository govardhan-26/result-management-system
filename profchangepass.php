...
if(count($_POST)>0) {
$result = mysqli_query($con,"SELECT *from proflogintable WHERE username='" . $username . "'");
$row=mysqli_fetch_array($result);
if($_POST["currentPassword"] == $row["password"] && $_POST["newPassword"] == $_POST["confirmPassword"] ) {
mysqli_query($con,"UPDATE proflogintable set password='" . $_POST["newPassword"] . "' WHERE username='" . $username . "'");
?>
...
<br><br>
<a href="professordashboard.php" class="btn btn-danger"> BACK </a>
</form>
<br>
<br>
</body>
